...
$.fn.mywin=function(position){
		if(position&&position instanceof Object){
			...
			if(!isNaN(positionTop)){
				positionLeft=parseInt(positionTop);
			}
			var currentwin=this;
			...
			getLeft();
			getTop();
			currentwin.css({left:left,top:top}).fadeIn("slow");
			...
			$(window).resize(function(){
				...
				getLeft();
				getTop();
				currentwin.animate({left:left,top:top},50);
			});
